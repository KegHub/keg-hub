...
import { _ as _objectSpread2, b as _slicedToArray, d as _objectWithoutProperties, e as _extends } from './_rollupPluginBabelHelpers-eca9940e.js';
...
import { exists, throttle, noOp, isFunc, isObj, isStr, get, checkCall, noPropArr, noPropObj } from '@keg-hub/jsutils';
...
import { SafeAreaView, SectionList as SectionList$2 } from 'react-native-web';
...
var _excluded = ["activeSection", "className", "innerClassName", "indexSectionHeaderBy", "keyExtractor", "noSectionHeaderScroll", "scrollCooldown", "onScrollSectionChange", "onSectionChange", "renderListHeader", "renderSectionHeader", "renderItem", "sectionChangeOffset", "sections", "styles", "themePath", "type"];
...
var useKeyExtractor = function useKeyExtractor(keyExtractor) {
  return useCallback(function (item, index) {
    return isFunc(keyExtractor) ? keyExtractor(item, index) : isObj(item) ? item.key || item.index || index : isStr(item) ? item : index;
  }, [keyExtractor]);
};
var SectionList$1 = React__default.forwardRef(function (props, ref) {
  ...
  var itemKeyExtractor = useKeyExtractor(keyExtractor);
  ...
  }, React__default.createElement(SectionList$2, _extends({
...
//# sourceMappingURL=sectionList-6bd7ed68.js.map
