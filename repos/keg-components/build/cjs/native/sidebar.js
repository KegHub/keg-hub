...
var SidebarMain = reStyle.reStyle(view_native.View)({
  h: '100%'
});
var SidebarContainer = reStyle.reStyle(view_native.View)(function (theme, props) {
  return {
    fl: 1,
    shadowRadius: 6,
    alS: "stretch",
...
var ToggleMain = reStyle.reStyle(view_native.View)(function (theme, props) {
  return {
    position: 'absolute'
  };
});
