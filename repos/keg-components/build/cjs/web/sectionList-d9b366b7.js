  ...
  return React.useMemo(function () {
    return sections.map(function (section, index) {
      return _rollupPluginBabelHelpers._objectSpread2(_rollupPluginBabelHelpers._objectSpread2({}, section), {}, {
        __kegIndex: jsutils.get(section, indexBy) || section.key || section.index || index
      });
    });
  }, [sections]);
};
...
var useKeyExtractor = function useKeyExtractor(keyExtractor) {
  return React.useCallback(function (item, index) {
    return jsutils.isFunc(keyExtractor) ? keyExtractor(item, index) : jsutils.isObj(item) ? item.key || item.index || index : jsutils.isStr(item) ? item : index;
  }, [keyExtractor]);
};
var SectionList$1 = React__default["default"].forwardRef(function (props, ref) {
  ...
  }), text.Text), React__default["default"].createElement(reactNativeWeb.SafeAreaView, {
    ref: safeClassRef,
    style: listStyles === null || listStyles === void 0 ? void 0 : listStyles.content.container
  }, React__default["default"].createElement(reactNativeWeb.SectionList, _rollupPluginBabelHelpers._extends({
...
//# sourceMappingURL=sectionList-d9b366b7.js.map
