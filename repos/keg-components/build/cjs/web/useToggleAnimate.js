...
var defConfig = {
  duration: 1000,
  easing: reactNativeWeb.Easing.linear,
  toValue: 0
};
...
var useToggleAnimate = function useToggleAnimate(props) {
  ...
  var _useState = React.useState(new reactNativeWeb.Animated.Value(values.current.from)),
  ...
  React.useLayoutEffect(function () {
    ...
    reactNativeWeb.Animated.timing(animation, buildConfig(config, aniChanges)).start(function () {
