...
/**
  ...
  */
export function buildElementCountMap(arr: any[]): Map<any, number>;
/**
  ...
  * </ul>
  */
export function areCountMapsEqual(mapA: Map<any, number>, mapB: Map<any, number>): boolean;
/**
  ...
  * </ul>
  */
export function areFrequencyEqual(arr: any[], otherArr: any[]): boolean;
...
/**
  ...
  */
export function areSetEqual(arr: any[], otherArr: any[]): void;
...
/**
  ...
  */
export function eitherArr(a?: any, b?: any): any;
...
/**
  ...
  */
export function ensureArr(val: any[] | any): any[];
...
/**
  ...
  */
export function findExtrema(arr: any[], comparator: (extremaSoFar: any, next: any) => any): any;
...
/**
  ...
  */
export function findMax(arr: object[], propSelector: (prop:any) => any): void;
...
/**
  ...
  * @param propSelector - <p>optional property selector for choosing the property to compare with</p>
  */
export function findMin(arr: object[], propSelector: (prop:any) => any): void;
...
/**
  ...
  * </ul>
  */
export function flatArr(arr: any[], opts?: {
    truthy: boolean;
    exists: boolean;
    mutate: boolean;
}): any[];
...
/**
  ...
  */
export function flatMap(arr: any[], mapFn: (current:any) => any): void;
...
/**
  ...
  * </ul>
  */
export function flatUnion(...params: any[]): any[];
...
/**
  ...
  */
export function omitRange(arr: any[], startIndex: number, count: number): void;
...
/**
  ...
  * </ul>
  */
export function randomArr(arr: any[], amount?: number): any[];
...
/**
  ...
  */
export function uniqArrByReference(arr: any[]): any[];
...
/**
  ...
  * @returns <p>copy of passed in array, with duplicates removed</p>
  */
export function uniqArr(arr: any[], selector: (element: any) => any): any[];
...
/**
  ...
  */
export function convertToStrBool(val: any): string;
...
/**
  ...
  */
export function isStrBool(val: any): boolean;
...
/**
  ...
  * </ul>
  */
export function softFalsy(val: any): boolean;
...
/**
  ...
  * </ul>
  */
export function cleanColl(coll: Record<any, any>|any[], recursive?: boolean): any | any[];
...
/**
  ...
  * </ul>
  */
export function deepClone(obj: Record<any, any>|any[]): Record<any, any>|any[];
...
/**
  ...
  */
export function deepEqual(a: Record<any, any>|any[], b: Record<any, any>|any[]): boolean;
...
/**
  ...
  * </ul>
  */
export function get(obj: Record<any, any>|any[], path: string | string[], fallback?: any): any;
...
/**
  ...
  */
export function isColl(val: any): boolean;
...
/**
  ...
  * </ul>
  */
export function isEmptyColl(obj: Record<any, any>|any[]): boolean;
...
/**
  ...
  */
export function mapColl(coll: Record<any, any>|any[]): Record<any, any>|any[];
...
/**
  ...
  * </ul>
  */
export function mapFind(coll: Record<any, any>|any[], mapper: (...params: any[]) => any, testFunc: (...params: any[]) => any): any;
...
/**
  ...
  * </ul>
  */
export function reduceColl(obj: Record<any, any>|any[], cb: (key:string, value:any, coll:Record<any, any>|any[], data:any) => any, reduce?: any): any;
...
/**
  ...
  * </ul>
  */
export function repeat(element: any, times: number, cloneDeep?: boolean): any[];
...
/**
  ...
  * </ul>
  */
export function set(obj: Record<any, any>|any[], path: string | string[], finalValue: any): any;
...
/**
  ...
  * </ul>
  */
export function shallowEqual(col1: Record<any, any>|any[], col2: Record<any, any>|any[], path: string|string[]): boolean;
...
/**
  ...
  * </ul>
  */
export function unset(obj: Record<any, any>|any[], path: string|string[]): void;
...
/**
  ...
  */
export function either(val1?: any, val2?: any, check?: (v1:any, v2:any) => any): any;
...
/**
  ...
  */
export function isEmpty(val: any | any[]): boolean;
...
/**
  ...
  */
export function isSame(val1: any, val2: any): boolean;
...
/**
  ...
  */
export const noPropObj: {content: {}};
...
/**
  ...
  */
export function strToType(val: any): any | string;
...
/**
  ...
  */
export function setLogs(log: boolean, methDef?: string, prefix?: string): void;
...
/**
  ...
  */
export function logData(args: any[]): void;
...
/**
  ...
  */
export function applyToFunc(item: any, expression: any): void;
...
/**
  ...
  * </ul>
  */
export function checkCall(method: (...params: any[]) => any, params: any): any;
...
/**
  ...
  */
export function cloneFunc(func: (...params: any[]) => any): any;
...
/**
  ...
  * </ul>
  */
export function compareTo(x: string | number | boolean, y: string | number | boolean): number | null;
...
/**
  ...
  */
export function complement(predicate: (...params: any[]) => any): (...params: any[]) => any;
...
/**
  ...
  */
export function debounce(func: (...params: any[]) => any, wait: number, immediate: boolean): void;
...
/**
  ...
  */
export function doIt(last: (...params: any[]) => any): void;
...
/**
  ...
  */
export function eitherFunc(func1: (...params: any[]) => any, func2: (...params: any[]) => any): (...params: any[]) => any;
...
/**
  ...
  */
export function isFunc(test: any): boolean;
...
/**
  ...
  * </ul>
  */
export function isOrderable(x: any): boolean;
...
/**
  ...
  * </ul>
  */
export function limbo(promise: Promise<any>): Promise<[err?:Error, response?:any]>;
...
/**
  ...
  * </ul>
  */
export function match(matchArg: any, entries: any[]): any;
...
/**
  ...
  */
export function memorize(func: (...params: any[]) => any, getCacheKey: (...params: any[]) => any): (...params: any[]) => any;
...
/**
  ...
  * </ul>
  */
export function parseErrorMessage(exception: any): string;
...
/**
  ...
  * </ul>
  */
export function pipeline(item: any, ...functions: ((...params: any[]) => any)[]): any;
...
/**
  ...
  * </ul>
  */
export function runSeq(asyncFns: ((...params: any[]) => void)[]): Promise<any[]>;
...
/**
  ...
  */
export function throttle(func: any, wait?: number): (...params: any[]) => any;
...
/**
  ...
  * @returns <p>throttled function</p>
  */
export function throttleLast(func: (...params: any[]) => any, cb: (...params: any[]) => any, wait?: number): (...params: any[]) => any;
...
/**
  ...
  */
export function timedRun(fn: (...params: any[]) => any, ...args: any[]): Promise<any[]>;
...
/**
  ...
  * </ul>
  */
export function uuid(start?: number): string;
...
/**
  ...
  * </ul>
  */
export function waitForIt(): Promise<any>;
...
/**
  ...
  */
export function addToProcess(addEnvs: any, options: {
    force: boolean;
}): void;
...
/**
  ...
  * </ul>
  */
export function findProc(procName: string, opts: any): any;
...
/**
  ...
  * </ul>
  */
export function getRelativePath(pathToModule: string): string;
...
/**
  ...
  * </ul>
  */
export function requireModule(pathToModule: string, config: {
    rootDir: string;
    logErrors: boolean;
}): any | ((...params: any[]) => any);
...
/**
  ...
  * </ul>
  */
export function loadByType(foundModule: any | any[] | ((...params: any[]) => any), params: any): any;
...
/**
  ...
  * </ul>
  */
export function loopLoad(pathsToModule: any[], config: {
    rootDir: string;
    logErrors: boolean;
}, params: any[]): any;
...
/**
  ...
  * </ul>
  */
export function loadModule(pathsToModule: string[] | string, config?: {
    rootDir?: string;
    logErrors?: boolean;
...
/**
  ...
  */
export function tryRequireSync(filePath: string): any;
...
/**
  ...
  * @returns <p>the export at path, if it exists, null otherwise</p>
  */
export function tryRequire(filePath: string): Promise<any>;
...
/**
  ...
  */
export function equalsNaN(val: number): boolean;
...
/**
  ...
  */
export function getNums(val: any): string;
...
/**
  ...
  * </ul>
  */
export function isNonNegative(val: any): boolean;
...
/**
  ...
  * @returns <p>T/F - if value is a number</p>
  */
export function isNum(val: number): boolean;
...
/**
  ...
  */
export function applyToCloneOf(obj: Record<any, any>, mutatorCb: (obj:Record<any, any>) => void): Record<any, any>;
...
/**
  ...
  */
export function clearObj(obj: Record<any, any>, filter?: string[]): void;
...
/**
  ...
  * </ul>
  */
export function deepMerge(...sources: any[]): Record<any, any> | any[];
...
/**
  ...
  */
export function eitherObj(obj1?: Record<any, any>, obj2?: any): any;
...
/**
  ...
  * </ul>
  */
export function everyEntry(obj: Record<any, any>, predicate: (...params: any[]) => any, logError?:boolean): boolean;
...
/**
  ...
  * </ul>
  */
export function filterObj(obj: Record<any, any>, predicate: (key:string, value:string) => boolean, logError?:boolean): Record<any, any>;
...
/**
  ...
  */
export function hasOwn(obj: Record<any, any>, prop: string): boolean;
...
/**
  ...
  * </ul>
  */
export function isArrMap(obj: any): boolean;
...
/**
  ...
  * </ul>
  */
export function isEntry(maybeEntry: any): boolean;
...
/**
  ...
  */
export function jsonEqual(one: any, two: any): boolean;
...
/**
  ...
  */
export function keyMap(arr: string[], toUpperCase?: boolean): Record<string, string>;
...
/**
  ...
  * </ul>
  */
export function mapEntries(obj: any | any[], cb: (key:string, value:any) => [string, any]): Record<string, any>;
...
/**
  ...
  * </ul>
  */
export function mapKeys(obj: Record<string, any>, keyMapper: (key:string) => any): Record<string, any>;
...
/**
  ...
  * </ul>
  */
export function mapObj(obj: Record<string, any>, cb: (key:string, values:string) => any): any[];
...
/**
  ...
  */
export function omitKeys(target: Record<string, any>, keys: string[]): Record<string, any>;
...
/**
  ...
  * </ul>
  */
export function reduceObj(obj: Record<string, any>, cb: (key: string, value: any, data: any) => any, start?:any): any;
...
/**
  ...
  * </ul>
  */
export function sanitizeCopy(obj: Record<string, any>): Record<string, any>;
...
/**
  ...
  * </ul>
  */
export function someEntry(obj: Record<string, any>, predicate: (key:string, value:string) => boolean, logError?:boolean): boolean;
...
/**
  ...
  * </ul>
  */
export function splitByKeys(target: Record<string, any>, keys: string[]): Record<string, any>;
...
/**
  ...
  * </ul>
  */
export function toObj(val: string[]|string, divider?: string, split?: string): Record<string, any>;
...
/**
  ...
  * </ul>
  */
export function trimStringFields(object: Record<string, any>): Record<string, any>;
...
/**
  ...
  * </ul>
  */
export function promisify(method: (...params: any[]) => any): Promise<(...params: any[]) => void>;
...
/**
  ...
  * </ul>
  */
export function addAsync(object: any): any;
...
/**
  ...
  * </ul>
  */
export function promisifyAll(object: any): any;
...
/**
  ...
  */
export function getRegexSource(maybeRx: any): string;
...
/**
  ...
  */
export function joinRegex(...expressions: RegExp[]): void;
...
/**
  ...
  * </ul>
  */
export function buildPath(...args: any[]): string;
...
/**
  ...
  * </ul>
  */
export function capitalize(string: string, lowercaseTail?: boolean): string;
...
/**
  ...
  * </ul>
  */
export function containsStr(string: string, substring: string, fromIndex?: number): boolean;
...
/**
  ...
  * </ul>
  */
export function delimitString(str: string, delimiter: string, delimiters?: string[]): string;
...
/**
  ...
  */
export function eitherStr(str1?: any, str2?: any): any;
...
/**
  ...
  */
export function getWordEndingAt(text: string, index: number, delimiters?: string[]): void;
...
/**
  ...
  * ending delimiters</p>
  */
export function getNearestDelimiterIndex(text: string, index: number, delimiters?: string[]): void;
...
/**
  ...
  */
export function getWordStartingAt(text: string, index: number, delimiters?: string[]): void;
...
/**
  ...
  * </ul>
  */
export function hyphenator(str: string): string;
...
/**
  ...
  */
export function isQuoted(str: string, quotes?: string[]): boolean;
...
/**
  ...
  * </ul>
  */
export function mapString(str: string, charMapper: (char:string) => any): string;
...
/**
  ...
  */
export function spaceJoin(original: string, toAdd: string | string[]): string;
...
/**
  ...
  * </ul>
  */
export function styleCase(str: string): string;
...
/**
  ...
  * </ul>
  */
export function template(template: string, data: Record<any, any>|any[], fallback?: any): string;
...
/**
  ...
  * </ul>
  */
export function trainCase(string: string): string;
...
/**
  ...
  * </ul>
  */
export function wordCaps(string: string): string;
...
/**
  ...
  * </ul>
  */
export function getURLParam(paramKey: string): string;
 ...
 * </ul>
 */
export function validate(argObj: Record<string, any>, validators: Record<string, any>, options: TValidateOpts): TValidateResponse;
