...
import { u as updateColl, g as get } from './get-f2eedd36.js';
...
const mapFind = (coll, mapper, test = exists) => {
  ...
  return isObj(coll) ? mapFindObj(coll, mapper, test) : mapFindArr(coll, mapper, test);
};
...
export { mapFind as a, repeat as b, cleanColl as c, deepEqual as d, isEmptyColl as i, mapColl as m, reduceColl as r, shallowEqual as s, unset as u };
//# sourceMappingURL=shallowEqual-34689b3f.js.map
